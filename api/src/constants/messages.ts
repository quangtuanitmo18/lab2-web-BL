export const USERS_MESSAGES = {
  ...
  FIRSTNAME_MUST_BE_A_STRING: 'first name must be a string',
  FIRSTNAME_LENGTH_MUST_BE_FROM_1_TO_100: 'first name length must be from 1 to 100',
  LASTNAME_IS_REQUIRED: 'last name is required',
  LASTNAME_MUST_BE_A_STRING: 'last name must be a string',
  LASTNAME_LENGTH_MUST_BE_FROM_1_TO_100: 'last name length must be from 1 to 100',
  MIDDLENAME_IS_REQUIRED: 'middle name is required',
  MIDDLENAME_MUST_BE_A_STRING: 'middle name must be a string',
  MIDDLENAME_LENGTH_MUST_BE_FROM_1_TO_100: 'middle name length must be from 1 to 100',
  GROUP_IS_REQUIRED: 'group is required',
  GROUP_MUST_BE_A_STRING: 'group must be a string',
  FACULTY_IS_REQUIRED: 'faculty is required',
  FACULTY_MUST_BE_A_STRING: 'faculty must be a string',
  EMAIL_ALREADY_EXISTS: 'Email already exists',
  EMAIL_IS_REQUIRED: 'Email is required',
  EMAIL_IS_INVALID: 'Email is invalid',
  COURSE_IS_REQUIRED: 'Course is required',
  COURSE_MUST_BE_A_NUMBER: 'Course must be a number',
